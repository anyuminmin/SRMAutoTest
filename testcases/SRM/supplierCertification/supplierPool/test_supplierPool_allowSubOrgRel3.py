...
def test_save_supplier_pool(json_headers):
	...
	_data['relOrganizationList'] = []  # 当不可引用时，其入参引用公司为[]
...
def test_save_fail_supplier_pool(json_headers, supplier_pool_code, supplier_pool_name, message):
	...
	assert response.json()['success']is False, response.json()['message']
...
if __name__ == '__main__':
	pytest.main("-s,-v,test_supplierPool_allowSubOrgRel3.py")
